 ...
 */
export const artworkFallbackMutation = (options?: Partial<Options<ArtworkFallbackData>>): UseMutationOptions<ArtworkFallbackResponse, ArtworkFallbackError, Options<ArtworkFallbackData>> => {
    const mutationOptions: UseMutationOptions<ArtworkFallbackResponse, ArtworkFallbackError, Options<ArtworkFallbackData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await artworkFallback({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
