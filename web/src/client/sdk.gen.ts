 ...
 */
export const artworkFallback = <ThrowOnError extends boolean = false>(options: Options<ArtworkFallbackData, ThrowOnError>): RequestResult<ArtworkFallbackResponses, ArtworkFallbackErrors, ThrowOnError> => (options.client ?? client).post<ArtworkFallbackResponses, ArtworkFallbackErrors, ThrowOnError>({
